...
define(function(require, exports, module) {
  ...
  var cypherStartcCommandSpec = {
    ...
    examples: [
      { example: 'start n=node(0) return n', description:'Lookup node with id 0, and return it'},
      { example: 'start n=node(*) return n', description:'Lookup all nodes, returning them'}
    ]
