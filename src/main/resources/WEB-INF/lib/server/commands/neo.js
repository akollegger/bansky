...
exports.startup = function() {
  gcli.addCommand(neoCmdSpec);
};

exports.shutdown = function() {
  gcli.removeCommand(neoCmdSpec);
};
...
var neoCmdSpec = {
  name: 'neo',
  description: 'Build the basic GCLI web target for Neo4j',
  returnType: 'terminal',
  exec: function(args, context) {
    return exports.buildNeo();
  }
};
...
exports.buildNeo = function() {
  ...
  copy({
    source: {
      ...
      require: [ 'gcli/index', 'cypher/index', 'gclitest/index' ]
    },
  ...
  copy({ source: 'cypher.html', filter: tweakIndex, dest: 'built/index.html' });
